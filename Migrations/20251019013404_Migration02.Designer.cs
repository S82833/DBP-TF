...
namespace ProyectoDBP.Migrations
{
    ...
    [Migration("20251019013404_Migration02")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProyectoDBP.Models.HistorialClinico", b =>
                {
                    b.Property<int>("IdHistorialClinico")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdHistorialClinico"));
                    ...
                    b.Property<string>("FuncionesBio")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("RelatoCron")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SignosSintomas")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ProyectoDBP.Models.ServicioStaff", b =>
                {
                    ...
                    b.Property<int>("StaffMedicoIdStaffMedico")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StaffMedicoIdStaffMedico");
            ...
            modelBuilder.Entity("ProyectoDBP.Models.HistorialClinico", b =>
                {
                    b.HasOne("ProyectoDBP.Models.Cita", "Cita")
                        .WithOne("HistorialClinico")
                        .HasForeignKey("ProyectoDBP.Models.HistorialClinico", "IdCita")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProyectoDBP.Models.ServicioStaff", b =>
                {
                    ...
                    b.HasOne("ProyectoDBP.Models.StaffMedico", "StaffMedico")
                        .WithMany("ServiciosStaff")
                        .HasForeignKey("StaffMedicoIdStaffMedico")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
